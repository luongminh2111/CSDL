package resource.TrinhDoNhanVien;

import DAO.controll.DtbEducation;
...
import static DAO.controll.DtbEducation.getTDNV;
...
public class TrinhDoNhanVien implements Initializable {
    ...
    public void edit()
    {
        DtbEducation connectionNow = new DtbEducation();
        Connection connectDB = connectionNow.ConnectionDb();
        try
        {
