...
import static DAO.controll.DtbLaborContract.getHDLD;

import DAO.controll.DtbLaborContract;
...
public class HopDongLaoDong implements Initializable {
    ...
    public void edit()
    {
        DtbLaborContract connectionNow = new DtbLaborContract();
    ...
    void searchUser()
    {
        ...
        nbdColum.setCellValueFactory(new PropertyValueFactory<>("ngayBD"));
        nktColum.setCellValueFactory(new PropertyValueFactory<>("ngayKT"));
        dataList = DtbLaborContract.getHDLD();
