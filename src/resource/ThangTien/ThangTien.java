package resource.ThangTien;

import DAO.controll.DtbPositionPromotion;
...
public class ThangTien implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        listTT = DtbPositionPromotion.getTT();
        tableTT.setItems(listTT);
    }

    public void ADD() throws SQLException {
        DtbPositionPromotion connectionNow = new DtbPositionPromotion();
